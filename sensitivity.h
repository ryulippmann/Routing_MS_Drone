...
/// </returns>
vector <pair < pair<int, int>, pair<double, FullSoln> >> VaryNum_clustXdrone(const Problem& inst, string& sens_run) {
...
/// </returns>
vector <pair < pair<int, int>, pair<double, FullSoln> >> Vary_dCap(const Problem& inst, string& sens_run) {
	sens_run = "_vary_dCap";
